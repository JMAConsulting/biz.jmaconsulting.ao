...
HERESQL;
    ...
    $query .= <<<HERESQL
        ...
        LEFT JOIN (
         (SELECT rb.* FROM civicrm_relationship rb WHERE rb.contact_id_b = {$userID})
           UNION
         (SELECT ra.* FROM civicrm_relationship ra WHERE ra.contact_id_a = {$userID})
        ) case_relationship ON case_relationship.case_id = civicrm_case.id AND case_relationship.is_active
